 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Esc    |   1  |   2  |   3  |   4  |   5  |  L1  |           |  L1  |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  _   |           |  Del |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
             ...
             MEH_T(KC_NO),KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                  KC_DOWN,KC_UP  ,KC_LBRC,KC_RBRC,          TG(WIND),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_TRNS,KC_TRNS,KC_SLEP,KC_TRNS,
                                       KC_TRNS,KC_TRNS,
                                               KC_TRNS,
...
void matrix_init_user(void) {
    // Is there a way to detect the OS and activate layer 3?
};
